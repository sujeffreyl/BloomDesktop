...
//        }
		...
		internal void UpdateMetadataFeatures(IEnumerable<string> allowedLanguages = null)
		{
			// Language-specific features
			UpdateBlindFeature(allowedLanguages);
			UpdateTalkingBookFeature(allowedLanguages);

			// Sign Language is a special case - the SL videos are not marekd up with lang attributes
			UpdateSignLanguageFeature();
		...
		/// </summary>
		/// <param name="allowedLanguages">If non-null, limits the calculation to only considering the languages specified</param>
		private void UpdateBlindFeature(IEnumerable<string> allowedLanguages = null)
		{
		...
		/// </summary>
		/// <param name="allowedLanguages">If non-null, limits the calculation to only considering the languages specified</param>
		private void UpdateTalkingBookFeature(IEnumerable<string> allowedLanguages = null)
		{
		...
		/// </summary>
		private void UpdateSignLanguageFeature()
		{
			if (HasSignLanguageVideos())
		...
		{
			// For now, are model is that quizzes are a language-independent feature.
